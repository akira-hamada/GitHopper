...
function loadPrefWindow() {
  ...
  preference = new BrowserWindow({width: 600, height: 540, resizable: false})
  ...
  template = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'Focus to Repositories Filter', accelerator: 'Shift+CmdOrCtrl+F', click: function() { mainWindow.webContents.send('onShortcutTriggered', 'shift+f'); } },
        { type: 'separator' },
        { label: 'Initial View', accelerator: 'Shift+CmdOrCtrl+T', click: function() { mainWindow.webContents.send('onShortcutTriggered', 'shift+t'); } },
